...
export const mockIssues: CivicIssue[] = [
  {
    ...
    updatedAt: new Date("2026-08-18T10:30:00Z"),
  },
  {
    id: "2",
    ...
    reportedBy: mockUsers[0],
    assignedTo: { id: mockUsers[2].id, name: mockUsers[2].name, department: mockUsers[2].department ?? "Public Works" },
  ...
  },
  {
    ...
    resolvedAt: new Date("2026-08-14T11:30:00Z"),
  },
]
